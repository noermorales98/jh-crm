 ...
 * - PENDING: editar / cancelar; link Stripe si hay cotización cobrable.
 * - RECEIVED: reembolsar; link Stripe opcional para saldo restante.
 */
export function PaymentRowActions({ payment }: { payment: PaymentRowData }) {
  ...
  const canStripe =
    Boolean(payment.quoteId) &&
    ["SENT", "ACCEPTED", "PARTIAL"].includes(payment.quoteStatus ?? "");
