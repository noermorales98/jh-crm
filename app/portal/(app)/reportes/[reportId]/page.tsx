...
export const metadata: Metadata = { title: "Reporte de progreso" };
...
export default async function PortalProgressReportPage({
  params,
}: {
  ...
  let report: Awaited<ReturnType<typeof portal.getPortalProgressReport>>;
  try {
    report = await portal.getPortalProgressReport(
      ctx.clientId,
      ctx.organizationId,
      reportId,
    );
